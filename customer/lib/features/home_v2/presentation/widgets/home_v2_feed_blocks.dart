...
import 'package:shopxy_customer/features/home_v2/presentation/pages/section_products_page.dart';
...
class HomeFeedBlock extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return switch (block) {
      ...
      CarouselBlock b => HomeV2ProductCarousel(
          eyebrow: b.eyebrow,
          title: b.title,
          products: b.products,
      ...
      CuratedRailBlock b => HomeV2CuratedRail(item: b.item),
      CollectionBannerBlock b =>
        HomeV2CollectionBanner(tiles: b.tiles, title: b.title),
      SponsoredCarouselBlock b => HomeV2ProductCarousel(
          eyebrow: 'SPONSORED',
      ...
      RecentlyViewedBlock b => HomeV2RecentlyViewed(items: b.products),
    };
  }
}
...
void _openProduct(BuildContext context, ProductCard p) {
  Navigator.of(context).push(
    MaterialPageRoute(
      builder: (_) => ProductDetailV2Page(productId: p.productId),
    ),
  );
}
      ...
      children: [
        ...
        Padding(
          ...
          child: GridView.builder(
            ...
            itemBuilder: (_, i) => HomeV2ProductTile(
              product: products[i],
              width: null,
            ),
          ),
