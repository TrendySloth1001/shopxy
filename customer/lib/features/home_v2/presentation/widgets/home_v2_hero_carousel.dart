...
class HomeV2HeroCarousel extends StatefulWidget {
  const HomeV2HeroCarousel({super.key, required this.slides});
  final List<HeroSlide> slides;

  @override
  State<HomeV2HeroCarousel> createState() => _HomeV2HeroCarouselState();
}

class _HomeV2HeroCarouselState extends State<HomeV2HeroCarousel> {
