...
class HomeV2BrandSpotlight extends StatefulWidget {
  const HomeV2BrandSpotlight({super.key, required this.brands});
  final List<BrandSpotlight> brands;

  @override
  State<HomeV2BrandSpotlight> createState() => _HomeV2BrandSpotlightState();
}

class _HomeV2BrandSpotlightState extends State<HomeV2BrandSpotlight> {
