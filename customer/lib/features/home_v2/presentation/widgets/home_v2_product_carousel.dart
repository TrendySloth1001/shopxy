      ...
      children: [
        ...
        SizedBox(
          ...
          child: ListView.separated(
            ...
            itemBuilder: (context, i) => HomeV2ProductTile(product: products[i]),
          ),
        ),
      ],
    );
...
class HomeV2ProductTile extends StatelessWidget {
  const HomeV2ProductTile({super.key, required this.product, this.width = 158});
