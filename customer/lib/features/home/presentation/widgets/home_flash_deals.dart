...
class HomeFlashDeals extends StatefulWidget {
  const HomeFlashDeals({super.key, required this.deals});
  final List<FlashDealProduct> deals;

  @override
  State<HomeFlashDeals> createState() => _HomeFlashDealsState();
}

class _HomeFlashDealsState extends State<HomeFlashDeals> {
  Timer? _timer;
  ...
  @override
  void didUpdateWidget(covariant HomeFlashDeals oldWidget) {
