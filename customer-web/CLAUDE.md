# CLAUDE.md — customer-web

Next.js 16 (App Router) · TypeScript · Tailwind v4 · customer-facing web app.
Runs on **port 3009**. Companion to `merchant-web` (port 3010); keep shared
...
stubbed/deferred wiring that may need to be connected once the feature you're
building lands. When you finish an item, tick it off; when you stub, defer, or
simplify something, **add a row to `PENDING.md`** so it isn't forgotten.
