    ...
    <main className="mx-auto max-w-content px-lg pb-massive">
      <header className="py-xxxl">
        ...
        <p className="mt-sm max-w-form text-body-lg text-muted">
          The single source of truth ported from the Flutter customer app. Calm,
      ...
      <Section title="Home promo accents">
        <div className="grid grid-cols-2 gap-lg sm:grid-cols-3">
          {swatchesFrom(color.promo)}
        </div>
      </Section>
      <Divider />
      ...
      <Section title="Type scale">
        <div className="flex flex-col gap-md">
          <p className="text-display-sm">Display — balances, totals</p>
