    ...
    <div className="flex flex-col gap-xs">
      ...
      <div ref={rootRef} className="relative">
        <button
          ...
          aria-expanded={open}
          className={`flex h-10 w-full items-center gap-sm rounded-input border bg-white px-md text-left text-body-md outline-none transition-colors disabled:bg-surface-tint disabled:text-disabled ${
        ...
        {open ? (
          <div
            role="listbox"
            className="absolute left-0 right-0 z-20 mt-xs max-h-60 overflow-auto rounded-input border border-hairline bg-white py-xs shadow-menu"
          >
            {searchable ? (
              <div className="sticky top-0 flex items-center gap-sm border-b border-hairline bg-white px-md pb-xs">
