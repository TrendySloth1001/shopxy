...
export function ProductPicker({
  ...
  return (
    <Modal title="Pick a product" onClose={onClose} wide>
      <label className="flex items-center gap-sm rounded-input border border-hairline bg-white px-md focus-within:border-brand focus-within:ring-2 focus-within:ring-brand-soft">
