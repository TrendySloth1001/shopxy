...
const cell =
  "h-10 w-full rounded-input border border-hairline bg-white px-md text-body-md text-ink outline-none placeholder:text-subtle focus-visible:border-brand focus-visible:ring-2 focus-visible:ring-brand-soft";
const area =
  "w-full rounded-input border border-hairline bg-white px-md py-sm text-body-md text-ink outline-none resize-y placeholder:text-subtle focus-visible:border-brand focus-visible:ring-2 focus-visible:ring-brand-soft";
