      ...
      {items.map((item, i) => (
        <div key={i} className="flex items-center gap-sm">
          <input
            ...
            className="h-10 flex-1 rounded-input border border-hairline bg-white px-md text-body-md text-ink outline-none placeholder:text-subtle focus-visible:border-brand focus-visible:ring-2 focus-visible:ring-brand-soft"
          />
          <button
            type="button"
            onClick={() => remove(i)}
